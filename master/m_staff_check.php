...
if ($error != "") {
    ...
    echo '<form action="m_staff_done.php" method="post" accept-charset="utf-8"><button type="button" class="prev">修正する</button><input type="submit" value="登録する"></form>';
}
?>
			</main>
			</div>
